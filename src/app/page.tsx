...
const App: React.FC = () => {
  ...
  const fullText = "A Full-Stack Developer with a passion for building responsive, high-performance web applications.";
  ...
  const renderSkillBadges = (skillArray: string[]): JSX.Element => (
    <div className="flex flex-wrap gap-2">
      {skillArray.map((skill, index) => (
        <span key={index} className="bg-teal-600 text-xs font-semibold px-2.5 py-1 rounded-full text-white transition-all duration-300 hover:scale-105 hover:bg-teal-500">
          {skill}
        </span>
      ))}
    </div>
    ...
    <div className="antialiased font-inter bg-[#0a0a0a] text-[#E0E0E0] overflow-x-hidden">
      ...
      <header className="bg-gray-950 fixed top-0 inset-x-0 z-50 shadow-xl">
        ...
        {isMobileMenuOpen && (
          <div id="mobile-menu" className="md:hidden bg-gray-950 px-4 py-2">
            ...
            <a href="#experience" onClick={toggleMobileMenu} className="block py-2 hover:text-teal-400 transition-colors border-b border-gray-700">Experience</a>
      ...
      <section className="min-h-screen flex items-center justify-center text-center px-4 py-16 bg-gradient-to-br from-gray-950 to-gray-800">
        <div className="max-w-3xl">
          ...
          <a href="#contact" className="bg-teal-500 hover:bg-teal-600 transition-all text-white font-semibold py-3 px-8 rounded-full shadow-lg transform hover:scale-105 active:scale-95 duration-200">
            Get in Touch
          </a>
        </div>
      </section>
      ...
      <section id="experience" className="py-20 px-4">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-3xl sm:text-4xl font-bold text-center text-white mb-12 section-header">Experience</h2>
        ...
        <div className="container mx-auto max-w-5xl text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 animated-card">
            <div className="contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-teal-400 flex-shrink-0"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
              <a href="mailto:k.harikris59@gmail.com" className="text-lg text-gray-300 hover:text-teal-400 transition-colors">k.harikris59@gmail.com</a>
            </div>
            <div className="contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-teal-400 flex-shrink-0"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-4.62-4.62A19.79 19.79 0 0 1 2 3.18 2 2 0 0 1 4.18 1h3.18a2 2 0 0 1 2 1.72c.15.96.44 1.96.9 2.92a2 2 0 0 1-.98 2.3L7.75 11.25a17.6 17.6 0 0 0 6.56 6.56l1.53-1.54a2 2 0 0 1 2.3-.98c.96.46 1.96.75 2.92.9a2 2 0 0 1 1.72 2v3z"/></svg>
              <a href="tel:+917358882652" className="text-lg text-gray-300 hover:text-teal-400 transition-colors">+91-7358882652</a>
            </div>
            <div className="contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-teal-400 flex-shrink-0"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/><circle cx="12" cy="9" r="3"/></svg>
              <span className="text-lg text-gray-300">Tirupur, Tamil nadu, India</span>
            </div>
          </div>
          
          <form id="contact-form" onSubmit={handleFormSubmit} className="space-y-6 animated-card max-w-3xl mx-auto">
            ...
            <button type="submit" className="w-full bg-teal-500 hover:bg-teal-600 transition-all text-white font-semibold py-3 rounded-lg shadow-lg transform hover:scale-105 active:scale-95 duration-200">
              Send Message
            </button>
          </form>
